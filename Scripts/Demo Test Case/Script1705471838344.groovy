...
WebUI.setText(findTestObject('Object Repository/Page_Demo Web Shop. Login/input_Email'), 'myemail@example.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Demo Web Shop. Login/input_Password'), 'aeHFOx8jV/A=')
